...
{
    /// <summary>
    /// Represents a filter that selects entities where a field value is less than or equal to a specified value.
    /// </summary>
    public class LessThanOrEqualFilter : BaseFilter
    {
        /// <summary>
        ...
        /// <summary>
        /// Builds a LINQ expression to filter entities where the specified field value is less than or equal to the given value.
        /// </summary>
        ...
        public override Expression<Func<T, bool>> BuildExpression<T>()
        {
            ...
            // Create the LessThanOrEqual expression.
