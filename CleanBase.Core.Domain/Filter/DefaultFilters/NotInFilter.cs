...
{
    /// <summary>
    /// Represents a filter that excludes entities where the specified field value is within a given set of values.
    /// </summary>
    public class NotInFilter : BaseFilter
    {
        /// <summary>
        ...
        /// <summary>
        /// Builds a LINQ expression to filter entities where the specified field value is not in the given set.
        /// </summary>
        ...
        public override Expression<Func<T, bool>> BuildExpression<T>()
        {
            ...
            // Create a parameter representing the entity (e.g., "x").
            ...
            // Use LINQ Contains method to build the NotIn expression.
            var containsMethod = typeof(Enumerable)
                .GetMethods()
                .First(m => m.Name == "Contains" && m.GetParameters().Length == 2)
                .MakeGenericMethod(memberType);

            var containsCall = Expression.Call(containsMethod, constant, member);
